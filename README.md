...
<p align="center">
  <picture>
    <source media="(max-width: 760px) and (prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-13591b51-mobile-dark.svg">
    <source media="(max-width: 760px)" srcset="./assets/hero/agent-console-13591b51-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/hero/agent-console-13591b51-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/hero/agent-console-13591b51-light.svg">
    <img src="./assets/hero/agent-console-13591b51-dark.svg" alt="Ahmad Sobirin - Software Engineer & Builder" width="100%">
  </picture>
</p>
