...
try {
  ...
  if (readme.includes("Generated by GitHub Profile Agent Console") && config.joke?.enabled) {
    assert(readme.includes(JOKE_START) && readme.includes(JOKE_END), "Generated README is missing joke markers.");
  }
